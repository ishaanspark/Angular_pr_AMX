(*********************************************************************)
(*  AMX LLC                                                  *)
(*  Copyright (c) 2004-2007 AMX LLC. All rights reserved.    *)
(*********************************************************************)
(* Copyright Notice :                                                *)
(*    Copyright, AMX LLC, 2004-2007                                     *)
...
BTN_CHAN_UP                    = 22    // Button:         Go to next Station Preset (Momentary FB)
BTN_CHAN_DN                    = 23    // Button:         Go to prev Station Preset (Momentary FB)
BTN_SOURCE_VIDEO1              = 31    // Button:         *deprecated Input Source in favor of Input Select* Video 1 source select (Momentary FB)
BTN_SOURCE_VIDEO2              = 32    // Button:         *deprecated Input Source in favor of Input Select* Video 2 source select (Momentary FB)
BTN_SOURCE_VIDEO3              = 33    // Button:         *deprecated Input Source in favor of Input Select* Video 3 source select (Momentary FB)
BTN_SOURCE_AUX1                = 39    // Button:         *deprecated Input Source in favor of Input Select* Auxiliary 1 source select (Momentary FB)
BTN_MENU_CANCEL                = 43    // Button:         Press menu button cancel (Momentary FB)
BTN_MENU_FUNC                  = 44    // Button:         Press menu button menu (Momentary FB)
BTN_MENU_UP                    = 45    // Button:         Press menu up button (Momentary FB)
BTN_MENU_DN                    = 46    // Button:         Press menu down button (Momentary FB)
...
(*                         Display                         *)
(***********************************************************)
DEFINE_CONSTANT // Display Channels/Levels/Variable Text
...
BTN_VOL_DN                     = 25    // Button:         Ramp volume down (Channel FB)
BTN_VOL_MUTE                   = 26    // Button:         Cycle volume mute (Channel FB)
BTN_SOURCE_TV1                 = 30    // Button:         *deprecated Input Source in favor of Input Select* TV 1 source select (Momentary FB)
BTN_SOURCE_VIDEO1              = 31    // Button:         *deprecated Input Source in favor of Input Select* Video 1 source select (Momentary FB)
BTN_SOURCE_VIDEO2              = 32    // Button:         *deprecated Input Source in favor of Input Select* Video 2 source select (Momentary FB)
BTN_SOURCE_VIDEO3              = 33    // Button:         *deprecated Input Source in favor of Input Select* Video 3 source select (Momentary FB)
BTN_SOURCE_TAPE1               = 34    // Button:         *deprecated Input Source in favor of Input Select* Tape 1 source select (Momentary FB)
BTN_SOURCE_TAPE2               = 35    // Button:         *deprecated Input Source in favor of Input Select* Tape 2 source select (Momentary FB)
BTN_SOURCE_AUX1                = 39    // Button:         *deprecated Input Source in favor of Input Select* Auxiliary 1 source select (Momentary FB)
BTN_MENU_CANCEL                = 43    // Button:         Press menu button cancel (Momentary FB)
BTN_MENU_FUNC                  = 44    // Button:         Press menu button menu (Momentary FB)
BTN_MENU_UP                    = 45    // Button:         Press menu up button (Momentary FB)
...
BTN_TUNER_STATION_DN           = 226   // Button:         Decrement Channel (Momentary FB)
BTN_TUNER_PREV                 = 235   // Button:         Goto previous tuner station (Momentary FB)
BTN_LAMP_WARMING_FB            = 253   // Feedback Button:Lamp Warming FB (Channel FB)
BTN_LAMP_COOLING_FB            = 254   // Feedback Button:Lamp Cooling FB (Channel FB)
BTN_LAMP_POWER_FB              = 255   // Feedback Button:Lamp Power FB (Channel FB)
...
BTN_HVAC_FAN_STATUS            = 216   // Feedback Button:Fan status state feedback (Channel FB)
...
// Light Channels
BTN_LIGHT_RAMP_UP              = 24    // Button:         Ramp down light level (Momentary FB)
BTN_LIGHT_RAMP_DN              = 25    // Button:         Ramp up light level (Momentary FB)
BTN_LIGHT_ELEMENT_1            = 261   // Button:         Toggle Light Element 1 (Channel FB)
BTN_LIGHT_ELEMENT_2            = 262   // Button:         Toggle Light Element 2 (Channel FB)
BTN_LIGHT_ELEMENT_3            = 263   // Button:         Toggle Light Element 3 (Channel FB)
BTN_LIGHT_ELEMENT_4            = 264   // Button:         Toggle Light Element 4 (Channel FB)
BTN_LIGHT_ELEMENT_5            = 265   // Button:         Toggle Light Element 5 (Channel FB)
BTN_LIGHT_ELEMENT_6            = 266   // Button:         Toggle Light Element 6 (Channel FB)
BTN_LIGHT_ELEMENT_7            = 267   // Button:         Toggle Light Element 7 (Channel FB)
BTN_LIGHT_ELEMENT_8            = 268   // Button:         Toggle Light Element 8 (Channel FB)
BTN_LIGHT_ELEMENT_9            = 269   // Button:         Toggle Light Element 9 (Channel FB)
BTN_LIGHT_ELEMENT_10           = 270   // Button:         Toggle Light Element 10 (Channel FB)
BTN_LIGHT_ELEMENT_11           = 271   // Button:         Toggle Light Element 11 (Channel FB)
BTN_LIGHT_ELEMENT_12           = 272   // Button:         Toggle Light Element 12 (Channel FB)
BTN_LIGHT_ELEMENT_13           = 273   // Button:         Toggle Light Element 13 (Channel FB)
BTN_LIGHT_ELEMENT_14           = 274   // Button:         Toggle Light Element 14 (Channel FB)
BTN_LIGHT_ELEMENT_15           = 275   // Button:         Toggle Light Element 15 (Channel FB)
BTN_LIGHT_ELEMENT_16           = 276   // Button:         Toggle Light Element 16 (Channel FB)
BTN_LIGHT_ELEMENT_17           = 277   // Button:         Toggle Light Element 17 (Channel FB)
BTN_LIGHT_ELEMENT_18           = 278   // Button:         Toggle Light Element 18 (Channel FB)
BTN_LIGHT_ELEMENT_19           = 279   // Button:         Toggle Light Element 19 (Channel FB)
BTN_LIGHT_ELEMENT_20           = 280   // Button:         Toggle Light Element 20 (Channel FB)

#IF_NOT_DEFINED BTN_LIGHT_ELEMENT
INTEGER BTN_LIGHT_ELEMENT[]    =       // Group:          Toggle lighting element (Channel FB)
{
  261,  262,  263,  264,  265,
  266,  267,  268,  269,  270,
  271,  272,  273,  274,  275,
...
#END_IF // BTN_LIGHT_ELEMENT

// Light Levels
LVL_LIGHT_LEVEL_X              = 1     // Level:          Lighting levels (X)
LVL_LIGHT_LEVEL_Y              = 20    // Level:           (y)

// Light Variable Text

#IF_NOT_DEFINED TXT_LIGHT_ELEMENT_NAME
INTEGER TXT_LIGHT_ELEMENT_NAME[]=      // Text:           Lighting element names
{
  261,  262,  263,  264,  265,
  266,  267,  268,  269,  270,
  271,  272,  273,  274,  275,
...
#END_IF // TXT_LIGHT_ELEMENT_NAME

(***********************************************************)
(*                       LightSystem                       *)
(***********************************************************)
DEFINE_CONSTANT // LightSystem Channels/Levels/Variable Text

// LightSystem Channels
BTN_LIGHTSYS_RAMP_UP           = 24    // Button:         Ramp down light level (Momentary FB)
BTN_LIGHTSYS_RAMP_DN           = 25    // Button:         Ramp up light level (Momentary FB)
BTN_LIGHTSYS_ELEMENT_1         = 261   // Button:         Toggle Light Element 1 (Channel FB)
BTN_LIGHTSYS_ELEMENT_2         = 262   // Button:         Toggle Light Element 2 (Channel FB)
BTN_LIGHTSYS_ELEMENT_3         = 263   // Button:         Toggle Light Element 3 (Channel FB)
BTN_LIGHTSYS_ELEMENT_4         = 264   // Button:         Toggle Light Element 4 (Channel FB)
BTN_LIGHTSYS_ELEMENT_5         = 265   // Button:         Toggle Light Element 5 (Channel FB)
BTN_LIGHTSYS_ELEMENT_6         = 266   // Button:         Toggle Light Element 6 (Channel FB)
BTN_LIGHTSYS_ELEMENT_7         = 267   // Button:         Toggle Light Element 7 (Channel FB)
BTN_LIGHTSYS_ELEMENT_8         = 268   // Button:         Toggle Light Element 8 (Channel FB)
BTN_LIGHTSYS_ELEMENT_9         = 269   // Button:         Toggle Light Element 9 (Channel FB)
BTN_LIGHTSYS_ELEMENT_10        = 270   // Button:         Toggle Light Element 10 (Channel FB)
BTN_LIGHTSYS_ELEMENT_11        = 271   // Button:         Toggle Light Element 11 (Channel FB)
BTN_LIGHTSYS_ELEMENT_12        = 272   // Button:         Toggle Light Element 12 (Channel FB)
BTN_LIGHTSYS_ELEMENT_13        = 273   // Button:         Toggle Light Element 13 (Channel FB)
BTN_LIGHTSYS_ELEMENT_14        = 274   // Button:         Toggle Light Element 14 (Channel FB)
BTN_LIGHTSYS_ELEMENT_15        = 275   // Button:         Toggle Light Element 15 (Channel FB)
BTN_LIGHTSYS_ELEMENT_16        = 276   // Button:         Toggle Light Element 16 (Channel FB)
BTN_LIGHTSYS_ELEMENT_17        = 277   // Button:         Toggle Light Element 17 (Channel FB)
BTN_LIGHTSYS_ELEMENT_18        = 278   // Button:         Toggle Light Element 18 (Channel FB)
BTN_LIGHTSYS_ELEMENT_19        = 279   // Button:         Toggle Light Element 19 (Channel FB)
BTN_LIGHTSYS_ELEMENT_20        = 280   // Button:         Toggle Light Element 20 (Channel FB)

#IF_NOT_DEFINED BTN_LIGHTSYS_ELEMENT
INTEGER BTN_LIGHTSYS_ELEMENT[] =       // Group:          Toggle lighting preset (Channel FB)
{
  261,  262,  263,  264,  265,
  266,  267,  268,  269,  270,
  271,  272,  273,  274,  275,
...
#END_IF // BTN_LIGHTSYS_ELEMENT

// LightSystem Levels
LVL_LIGHTSYS_LEVEL_X           = 1     // Level:          Lighting levels (X)
LVL_LIGHTSYS_LEVEL_Y           = 20    // Level:           (y)

// LightSystem Variable Text

#IF_NOT_DEFINED TXT_LIGHTSYS_ELEMENT_NAME
INTEGER TXT_LIGHTSYS_ELEMENT_NAME[]=   // Text:           Lighting element names
{
  261,  262,  263,  264,  265,
  266,  267,  268,  269,  270,
  271,  272,  273,  274,  275,
...
#END_IF // TXT_LIGHTSYS_ELEMENT_NAME
...
BTN_SOURCE_TAPE1               = 34    // Button:         *deprecated Input Source in favor of Input Select* Tape 1 source select (Momentary FB)
BTN_SOURCE_TAPE2               = 35    // Button:         *deprecated Input Source in favor of Input Select* Tape 2 source select (Momentary FB)
BTN_SOURCE_CD1                 = 36    // Button:         *deprecated Input Source in favor of Input Select* CD 1 source select (Momentary FB)
BTN_SOURCE_TUNER1              = 37    // Button:         *deprecated Input Source in favor of Input Select* Tuner 1 source select (Momentary FB)
BTN_SOURCE_PHONO1              = 38    // Button:         *deprecated Input Source in favor of Input Select* Phono 1 source select (Momentary FB)
BTN_SOURCE_AUX1                = 39    // Button:         *deprecated Input Source in favor of Input Select* Auxiliary 1 source select (Momentary FB)
BTN_MENU_CANCEL                = 43    // Button:         Press menu button cancel (Momentary FB)
BTN_MENU_FUNC                  = 44    // Button:         Press menu button menu (Momentary FB)
BTN_MENU_UP                    = 45    // Button:         Press menu up button (Momentary FB)
...
// UPS Channels
BTN_UPS_OUTLET_STATE_1         = 434   // Button:         Toggle Outlet State 1 (Channel FB)
BTN_UPS_OUTLET_STATE_2         = 435   // Button:         Toggle Outlet State 2 (Channel FB)
BTN_UPS_OUTLET_STATE_3         = 436   // Button:         Toggle Outlet State 3 (Channel FB)
BTN_UPS_OUTLET_STATE_4         = 437   // Button:         Toggle Outlet State 4 (Channel FB)
BTN_UPS_OUTLET_STATE_5         = 438   // Button:         Toggle Outlet State 5 (Channel FB)
BTN_UPS_OUTLET_STATE_6         = 439   // Button:         Toggle Outlet State 6 (Channel FB)
