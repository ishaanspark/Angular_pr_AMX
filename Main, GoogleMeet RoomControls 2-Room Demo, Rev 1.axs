PROGRAM_NAME='Main, GoogleMeet RoomControls 2-Room Demo, Rev 1'
...
(***********************************************************)
DEFINE_DEVICE
dvSwitcher 		= 0:7:0 //Solvision-  SV04041UA 4x4 HDMI Matrix
...
data_event[vdvUiRoom1_1] 
{
	...
	send_command data.device,"'PROPERTY-webui-configuration-file,vaughn-GMRC.json'";
...
data_event[vdvUiRoom2_1] 
{
    ...
    {
  	send_command data.device,"'SERVER.PROPERTY-Duet-Device,',itoa(vdvWebServer.NUMBER),':',itoa(vdvWebServer.PORT),':',itoa(vdvWebServer.SYSTEM)";
	send_command data.device,"'PROPERTY-webui-configuration-file,einstein-GMRC.json'";
